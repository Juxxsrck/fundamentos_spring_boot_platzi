...
public class UserRestController {
    ...
    @PostMapping("/")
    ResponseEntity<User> newUser(User newUser){
    ...
    @PutMapping("/{id}")
    ResponseEntity<User> replaceUser(User newUser, @PathVariable Long id){
        return new ResponseEntity<>(updateUser.update(newUser, id), HttpStatus.OK);
    }

    @GetMapping("/pageable")
    List<User> getUserPagiable(@RequestParam int page, @RequestParam int size){
